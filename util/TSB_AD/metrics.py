...
class metricor:
    ...
    def metric_new(self, label, score, plot_ROC=False, alpha=0.2, ADAD=False, thres=None):
        '''input:
    ...
    def RangeAUC(self, labels, score, window=0, percentage=0, plot_ROC=False, AUC_type='window', ADAD=False):
